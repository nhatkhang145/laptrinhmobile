...
public class AreaManageActivity extends AppCompatActivity
    ...
    private TextView tvActiveAreas;
    private TextView tvHiddenAreas;

    private EditText etSearch;

    private int resId = -1;

    // Lắng nghe sự kiện thêm khu vực xong để refresh danh sách
    ...
    // Gọi API lấy danh sách khu vực và số lượng bàn của từng khu vực
            ...
            public void onResponse(Call<List<Area>> call, Response<List<Area>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (AreaList.isEmpty()) {
                        ...
                        // Lấy danh sách bàn để map số lượng
