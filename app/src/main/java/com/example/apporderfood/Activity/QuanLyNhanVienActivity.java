...
/**
 * Màn hình quản lý nhân viên của nhà hàng.
 *
 * Chức năng:
 * - Hiển thị danh sách nhân viên.
 * - Tìm kiếm nhân viên.
 * - Lọc theo vai trò.
 * - Thống kê số nhân viên đang hoạt động.
 * - Chuyển sang màn hình thêm nhân viên.
 */
public class QuanLyNhanVienActivity extends AppCompatActivity {
    ...
    /**
     * Tải lại danh sách nhân viên khi quay về màn hình.
     *
     * Bỏ qua lần đầu vì dữ liệu đã được tải trong onCreate().
     */
    @Override
    ...
    /**
     * Khởi tạo RecyclerView hiển thị danh sách nhân viên.
     */
    ...
    /**
     * Tải danh sách nhân viên của nhà hàng từ server.
     *
     * Sau khi lấy dữ liệu:
    ...
    /**
     * Chọn tab lọc nhân viên theo vai trò.
     *
     * roleId:
     * - null : Tất cả
     * - 1 : Quản lý
